...
public class LeaveRequestDTO {
	...
	public LeaveRequestDTO(Long userId, Long departmentId, ELeaveType leaveType, LocalDate startDate, LocalDate endDate,
			int leaveDuration, String reason, String approver, int sickTaken, int casualTaken, int paidLeaveTaken,
			int unPaidLeaveTaken, int maternityLeaveTaken, int paternityLeaveTaken, ELeaveStatus status,
